...
####  Data description
There are 200 players and 26 out of 37 columns are performance¡¦s data include before and after surgery.  All of the data is normal distribution and has different standard deviation.
...
Because in some columns the standard deviation is too big and will generate negative data which make no sense in baseball game. Although the standard deviation will change after I add the abs function.  It will be easier to simulate. 
...
I divided the data into two sets.  And find the correlation between categorical variable and perfromance's data after the surgery.

In each categoric data I list 5 of the related variable no matter it is positive or negative relative.

Pitching style:
* Innings_pitched_per_season_after
* Complete_games_per_season_after
* Runs_allowed_per_season_after
* Hits_allowed_per_season_after
* Losses_per_season_after

Pitching position:
* Innings_pitched_per_game_after 
* Innings_pitched_per_season_after 
* Game_played_after_surgery_after
* Complete_games_per_season_after 
* Shutouts_per_season_after

Side of injury:
* Complete_games_per_season_after
* Strikeouts_per_season_after
* ERA_per_season_after
* Losses_per_season_after
* Runs_allowed_per_season_after

Combine these results, I will choose 
* Innings_pitched_per_season_after
* Complete_games_per_season_after
* Runs_allowed_per_season_after
to run t test with data from before surgery to see the difference in pitcher's performance
...
After that I want to find some good models between three categorical variable and performance's data after surgery.
